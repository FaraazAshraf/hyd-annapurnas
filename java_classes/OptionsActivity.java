...
public class OptionsActivity extends AppCompatActivity {
        ...
        searchByLocationButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (hasPerm != PackageManager.PERMISSION_GRANTED) {
                    new com.ashraf.faraaz.hydannapurnas.UtilsClass().checkLocationPermission(OptionsActivity.this);
                    new com.ashraf.faraaz.hydannapurnas.UtilsClass().displayLocationSettingsRequest(OptionsActivity.this, OptionsActivity.this);
                }
                else {
                    new com.ashraf.faraaz.hydannapurnas.UtilsClass().displayLocationSettingsRequest(OptionsActivity.this, OptionsActivity.this);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if(requestCode == com.ashraf.faraaz.hydannapurnas.UtilsClass.LOCATION_PERMISSION_CODE) {
